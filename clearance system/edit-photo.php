...
<title>Edit Photo| Online Student clearance system</title>
            ...
            <div class="col-lg-7">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Edit Photo</h3>
...
<div class="form-group">
    ...
    <p>&nbsp;</p>
                ...
                <div align="center"><img src="<?php echo $rowaccess['photo'];   ?>" alt="studentphoto" width="178" height="154" id="logo-img">   
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <p>&nbsp;</p>
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p>
    <button type="submit" name="btnedit" class="btn btn-success">Update photo</button>
